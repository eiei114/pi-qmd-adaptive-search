...
function startBackgroundJob(root, input = {}) {
...
function finishBackgroundJob(root, runningJob, patch = {}) {
    const state = readJobState(root);
    const finished = {
        ...runningJob,
        ...patch,
...
function startQmdSearchJob(root, input = {}) {
    return startBackgroundJob(root, { type: 'qmd-search', input });
}
function finishQmdSearchJob(root, runningJob, qmdResult = {}) {
