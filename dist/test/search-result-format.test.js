...
import { compactSearchDetails, formatAdaptiveSearchToolResult, formatCompactSearchText } from '../src/search-result-format.js';
const sampleResult = {
    results: [
        {
...
//# sourceMappingURL=search-result-format.test.js.map